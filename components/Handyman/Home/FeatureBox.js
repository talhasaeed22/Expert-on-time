...
const FeatureBox = ({iconname, Icon, name}) => {
  return (
    <TouchableOpacity style={{display:"flex", flexDirection:'column', alignItems:"center", borderWidth:1, borderColor:'lightgray', padding:20, paddingHorizontal:35, borderRadius:15, gap:10}}>
